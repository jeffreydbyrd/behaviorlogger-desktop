...
public class RecordingRawJson1_0 {
	...
	public HashMap<Character, ArrayList<Long>> discretes;
	public HashMap<Character, ArrayList<Long>> continuous;
    }
	...
	for (BehaviorEvent b : details.behaviors) {
		...
		long start = b.startTime / 1000; // start-time in seconds
		long end = start + (((ContinuousBehavior) b).getDuration() / 1000); // end-time in seconds
