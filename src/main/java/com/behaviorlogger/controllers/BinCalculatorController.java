...
import com.behaviorlogger.models.BinManager;
import com.behaviorlogger.persistence.GsonUtils;
import com.behaviorlogger.persistence.WriteBinIntervals;
...
public class BinCalculatorController {
    ...
    @FXML
    private TextField binsizeField;
    @FXML
    private VBox appendBox;
    @FXML
    TextField appendField;
    @FXML
    ...
    private void browseBtnPressed(TextField fileField, String filterDescription, String... filterExtension) {
