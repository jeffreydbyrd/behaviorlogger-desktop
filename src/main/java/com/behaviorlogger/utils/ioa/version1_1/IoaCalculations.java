...
public class IoaCalculations {
    ...
    private static Map<String, IntervalCalculations> getIntervals(KeyToInterval data1, KeyToInterval data2,
    ...
    static Map<String, TimeWindowCalculations> windowAgreementDiscrete(KeyToInterval data1, KeyToInterval data2,
	    int threshold) {
	SetView<String> common = Sets.union(data1.keyToIntervals.keySet(), data2.keyToIntervals.keySet());
