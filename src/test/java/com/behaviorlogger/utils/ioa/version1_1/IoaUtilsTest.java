...
public class IoaUtilsTest {
    ...
    @Test
    public void deserialize_standard() throws Exception {
    ...
    @Test
    public void deserialize_multi() throws Exception {
    ...
    @Test
    public void partition_standard_blockSize_1() {
	int blockSize = 1;
	...
	KeyToInterval actualDiscrete = IoaUtils1_1.partition(mapD, standard.duration, blockSize);
	KeyToInterval actualContinuous = IoaUtils1_1.partition(mapC, standard.duration, blockSize);
    ...
    @Test
    public void partition_standard_blockSize_2() {
	int blockSize = 2;
    ...
    @Test
    public void partition_standard_blockSize_4() {
	int blockSize = 4;
    ...
    @Test
    public void partition_multi_blockSize_3() {
	int blockSize = 3;
	...
	KeyToInterval actualDiscrete = IoaUtils1_1.partition(mapD, multi.duration, blockSize);
	KeyToInterval actualContinuous = IoaUtils1_1.partition(mapC, multi.duration, blockSize);
    ...
    @Test
    public void partition_zero_length_blockSize_1() {
	int blockSize = 1;
	...
	KeyToInterval actualDiscrete = IoaUtils1_1.partition(mapD, zero_len.duration, blockSize);
	KeyToInterval actualContinuous = IoaUtils1_1.partition(mapC, zero_len.duration, blockSize);
